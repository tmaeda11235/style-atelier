          ...
          <div className="space-y-5 border-t border-slate-100 dark:border-slate-800 pt-4">
            ...
            <FeatureToggleGroup title={t.groupCardFeatures}>
              ...
              <FeatureToggleItem
                ...
                onChange={(checked) =>
                  updateExpertFeature("cardEditing", checked)
                }
              />
            </FeatureToggleGroup>
            ...
            <FeatureToggleGroup title={t.groupOrganization}>
              <FeatureToggleItem
                ...
                onChange={(checked) =>
                  updateExpertFeature("categories", checked)
                }
              />
              <FeatureToggleItem
            ...
            <FeatureToggleGroup title={t.groupWorkbench}>
              ...
              <FeatureToggleItem
                ...
                onChange={(checked) =>
                  updateExpertFeature("multiCard", checked)
                }
              />
              <FeatureToggleItem
                ...
                onChange={(checked) =>
                  updateExpertFeature("multiImage", checked)
                }
              />
            </FeatureToggleGroup>
          </div>
