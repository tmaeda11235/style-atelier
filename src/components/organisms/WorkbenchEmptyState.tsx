...
const CauldronGradients: React.FC<{ isDragOver: boolean }> = ({
  isDragOver
}) => (
  <defs>
...
const MagicFire: React.FC<{ isDragOver: boolean }> = ({ isDragOver }) => (
...
const CauldronMainBody: React.FC<{ isDragOver: boolean }> = ({
  isDragOver
}) => (
  <>
    <path
...
const CauldronBubbles: React.FC<{ isDragOver: boolean }> = ({ isDragOver }) => (
  <g opacity="0.8">
    <circle
      cx="45"
      cy="45"
...
const CauldronRimAndLiquid: React.FC<{ isDragOver: boolean }> = ({
  isDragOver
}) => (
  <>
    <ellipse
...
const CauldronGraphic: React.FC<{ isDragOver: boolean }> = ({ isDragOver }) => (
  <div
    ...
    <svg viewBox="0 0 120 120" className="w-full h-full drop-shadow-md z-10">
      <CauldronGradients isDragOver={isDragOver} />
