...
describe("mj-parser", () => {
  describe("extractJobIdFromUrl", () => {
    it("should extract job id from /jobs/ URL pattern", () => {
      const url = "https://www.midjourney.com/jobs/100cc076-ef20-46b4-8aeb-f7c294169800"
      expect(extractJobIdFromUrl(url)).toBe("100cc076-ef20-46b4-8aeb-f7c294169800")
    })

    it("should extract job id from cdn.midjourney.com URL pattern", () => {
      const url = "https://cdn.midjourney.com/100cc076-ef20-46b4-8aeb-f7c294169800/0_0.png"
      expect(extractJobIdFromUrl(url)).toBe("100cc076-ef20-46b4-8aeb-f7c294169800")
    })
