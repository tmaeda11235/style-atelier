...
- **Tutorial Spotlight & Position Synchronization**:
  ...
  - Decouples DOM calculations and window event handlers from the `InteractiveTutorial` overlay component (`src/features/tutorial/components/InteractiveTutorial.tsx`), maintaining clean separation of concerns and keeping component file size well within constraints (under 300 lines).
