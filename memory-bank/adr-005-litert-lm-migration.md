...
4. **Offscreen Process and Main Thread Blocking**:
   ...
   - **Crucial UI Requirement**: A loading indicator ("AI Engine Initializing...") must be displayed *before* triggering inference, and we must consider preloading the engine in the background when the panel opens.
