...
6. **Layer Boundaries, File Size & i18n Rules**
   ...
   - **File, Function & Complexity Limits**: Keep components under 300 lines (excluding blank lines and comments) and functions under 50 lines. Cognitive complexity limit is 15. Refactor when limits are exceeded. Detailed guidelines and compliance patterns are documented in [docs/DEVELOPMENT.md](file:///docs/DEVELOPMENT.md#L92).
